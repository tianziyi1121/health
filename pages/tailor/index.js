        ...
        setTimeout(() => {
            wx.canvasToTempFilePath({
                ...
                success: function (res) {
                  ...
                  // delete this.mangles;
                  wx.uploadFile({
                    url: 'https://www.rqxfj.com/index.php/api/nursing_workers/uploadFile', 
                    ...
                    success(resp) {
                      ...
                      if(data.status == 1){
                        app.globalData.image = data.data.url
                        toolTip.photoTip('上传成功', '')
                      }
                      wx.setStorageSync('ls_optionsId', 2)
                      wx.navigateBack({
                        delta: 1
                      })
                    },
                    fail(resp) {
                      toolTip.photoTip('上传失败', '../../static/fail.png')
                    }
                  })
                }
            })
